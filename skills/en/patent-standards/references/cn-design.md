...
> Verification: 2026-08-12 tested against the official CNIPA full texts (2020 专利法 text + 2023 实施细则 full text + 2023 审查指南 PDF full text); per-item evidence in `../../../../docs/research/design-patent-anchors.md`. **The 2023 细则 / 指南 have no mandatory six-view rule and no "3cm×3cm / 15cm×22cm" image-size numbers (2010 old rules deleted); views follow the number of faces involved by the design points.**
