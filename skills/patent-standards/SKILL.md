...
## Verified rule anchors (2026-08-11 实测核实)

Drafting-relevant article numbers verified against the official full texts (来源见下): the 2023 实施细则 from CNIPA (全文) and 专利法 2020 text from CNIPA. **Skills must cite these anchors — not chapter-level approximations — and never renumber from memory.**
...
| 第24条 | 申请日前6个月内的四种情形不丧失新颖性(紧急状态公共利益/国际展/学术会议/他人泄露) |
| 第26条 | 申请文件=请求书、说明书及其摘要和权利要求书;说明书应清楚完整、以本领域技术人员能够实现为准;权利要求书应以说明书为依据,清楚、简要地限定保护范围 |
| 第33条 | 修改不得超出原说明书和权利要求书记载的范围 |
| 第42条 | 发明20年/实用新型10年/外观15年,自申请日起算 |
...
| 第43条 | 收到请求书、说明书(实用新型必须包括附图)和权利要求书后确定申请日 |
