...
description: Reserved professional-group asset, hidden from discovery by default. US 112(b) claim compliance lint (English-only). To be redone when the professional-agent direction restarts.
...
Catalog: `../patent-standards/references/us.md`.
