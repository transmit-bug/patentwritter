...
Confirm `drafts/申请信息.md` four elements + `.patent/materials/` provenance. When an element is marked `blocked`, pause that part and ask the inventor for the missing piece; proceed only with confirmed material.
