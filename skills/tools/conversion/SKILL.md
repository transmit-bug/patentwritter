...
Ingestion output is **interview context, not a draft**: extracted text follows the extract-confirm-fill protocol in `../patent-intake/references/source-modes.md`; nothing is copied into `草稿/` without inventor confirmation.
