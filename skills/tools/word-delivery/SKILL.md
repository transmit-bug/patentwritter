...
- Any revision request — including complaints about a delivered `.docx` — is fixed in the owning draft (`权利要求书.md`, `说明书.md`, `摘要.md`, `技术交底书.md`), then this skill re-runs to regenerate. Never hand-edit a delivered `.docx`; never treat it as a source.
